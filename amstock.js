(function() {
    ...
    e.AmStockChart = e.Class({
        ...
        parseStockData: function(a, b, c, d, k) {
            ...
            if (n) {
                ...
                for (q = 0; q < t; q++) {
                    var B = h[q],
                        ...
                        z;
                    for (z =
                        0; z < E; z++) r[A[z].toField] = B[A[z].fromField];
                    for (z = g; z < m; z++) {
                        p = c[z];
                        ...
                        if (z == g || C >= y[p] || !y[p]) {
                            ...
                            l[p].push(v[p]);
                            z >
                                g && (u = e.newDate(D, b), u = e.changeDate(u, F, G, !0), u = e.resetDateToMin(u, F, G, d), y[p] = u.getTime());
                            if (z == g)
                                for (var I in B) B.hasOwnProperty(I) && (v[p][I] = B[I]);
                            v[p][n] = e.newDate(D, b)
                        } else
                            for (w = v[p], w.rawData && w.rawData.push(B), p = 0; p < E; p++) u = A[p].toField, q == t - 1 && (w[n] = e.newDate(D, b)), null !== r[u] && (x = Number(r[u]), isNaN(x) || (isNaN(w[u + "Low"]) && (w[u + "Low"] = x), x < w[u + "Low"] && (w[u + "Low"] = x), isNaN(w[u + "High"]) && (w[u + "High"] = x), x > w[u + "High"] && (w[u + "High"] = x), isNaN(w[u + "AbsHigh"]) && (w[u + "AbsHigh"] = x), Math.abs(x) > w[u +
            ...
            e.ifArray(a.stockEvents) ? 0 < f.processTimeout ? setTimeout(function() { f.parseEvents.call(f, a, f.panels, f.stockEventsSettings, f.firstDayOfWeek, f, f.dataDateFormat) }, f.processTimeout) : f.parseEvents(a, f.panels, f.stockEventsSettings, f.firstDayOfWeek,
                f, f.dataDateFormat) : (a.dataParsed = !0, f.onDataUpdated())
        },
        parseEvents: function(a, b, c, d, k, f) {
            ...
            for (var y in l)
                if (l.hasOwnProperty(y))
                    for (b =
                        l[y], h = e.extractPeriod(y), n = b.length, g = 0; g < d.length; g++) {
                        m = d[g];
                        q = m.date instanceof Date;
                        f && !q && (m.date = e.stringToDate(m.date, f));
                        q = m.date.getTime();
                        var v = this.getEventDataItem(q, b, a, 0, n, h);
                        v && (q = m.graph, p = m.panel, q && (t = "amCustomBullet" + q.id + "_" + p.id, q = "amCustomBulletConfig" + q.id + "_" + p.id, v[q] ? p = v[q] : (p = {}, p.eventDispatcher = k, p.eventObjects = [], p.letters = [], p.descriptions = [], p.shapes = [], p.backgroundColors = [], p.backgroundAlphas = [], p.borderColors = [], p.borderAlphas = [], p.colors = [], p.rollOverColors = [],
        ...
        zoomChart: function(a, b) {
            ...
            if (k && f) {
                ...
                for (k = 0; k < q.length; k++) {
                    ...
                    0 < g.startDuration && c.animationPlayed && !d ? (f.startDuration =
                        0, f.animateAgain()) : 0 < g.startDuration && !d && f.animateAgain()
                }
                c.animationPlayed = !0;
                g = e.newDate(b);
                p && c.updateScrollbar && (p.zoomToDates(a, g), c.skipScrollbarEvent = !0, setTimeout(function() { c.resetSkip.call(c) }, 100));
                c.updateScrollbar = !0;
                c.startDate = a;
                c.endDate = b;
                m && m.zoom(a, b);
                        ...
                        if (g.comparable) {
                            ...
                            if (g.valueAxis) {
                                ...
                                for (D = 0; D < B; D++) {
                                    ...
                                    g.compareGraph &&
                                        e.copyProperties(g.compareGraph, r);
                                    ...
                                    if (m) {
                                        ...
                                        c.showComparedOnTop ? c.graphs.push(r) :
                                            c.graphs.unshift(r);
        ...
        removePanel: function(a) {
            ...
            this.prevPH = void 0;
            var c;
            for (c = b.length - 1; 0 <= c; c--) b[c] == a && (this.fire({ type: "panelRemoved", panel: a, chart: this }), b.splice(c, 1), a.destroy(), a.clear())
        },
        validateData: function(a) {
            var b = this;
            b.validateDataTO && clearTimeout(b.validateDataTO);
            b.validateDataTO =
                setTimeout(function() { b.validateDataReal.call(b, a) }, 100)
        },
        ...
        showHideEvents: function(a) {
            ...
            for (c = 0; c < b.length; c++) {
                var d = b[c].graphs,
                    e;
                for (e = 0; e < d.length; e++) { var f = d[e];!0 === a ? f.showCustomBullets(!0) : f.hideCustomBullets(!0) }
            }
        },
        ...
        handleResize: function() {
            var a = this,
                b = setTimeout(function() { a.validateSizeReal() }, 150);
            a.initTO = b
        },
    ...
    e.PeriodSelector = e.Class({
        ...
        write: function(a) {
            ...
            if (e.ifArray(n)) {
                ...
                f || (g.style.cssFloat = "left", g.style.styleFloat = "right", g.style.display = "inline", g.className = "row", g.style.width = "100%", g.style.marginLeft = "10px");
                a.appendChild(g);
                f && e.addBr(g);
                ...
                var t;
                var j;
                for (a = 0; a < n.length; a++) c = n[a], j = document.createElement("div"), j.className = "col-xs-2 col-sm-2 col-md-2 col-lg-2", j.style.fontSize = "18px", j.style.textAlign = "center", t = document.createElement("input"),
                    t.type = "button", t.value = c.label, t.period = c.period, t.count = c.count, t.periodObj = c, t.className = "amChartsButton " + d + "-period-input", k && e.applyStyles(t.style, k.PeriodButton), f && (t.style.width = b.width - 1 + "px"), t.style.boxSizing = "border-box", t.style.width = "100%", j.appendChild(t), g.appendChild(j), b.addEventListeners(t), c.button = t;
        ...
        handleCalChange: function(a) {
            ...
            try { this.startDateField.blur(), this.endDateField.blur() } catch (k) {}
            if (c && b) {
                var d = { type: "changed" };
                d.startDate = c;
                d.endDate = b;
        ...
        selectPeriodButton: function(a, b, c) {
            ...
            g && m && ("MAX" == f ? (h = g, n = m) : "YTD" == f ? (h = new Date, h.setMonth(0, 1), h.setHours(0, 0, 0, 0), 0 === k && h.setDate(h.getDate() - 1), n = this.lastDate) : "YYYY" == f || "MM" == f ? h ?
                (h = g, n = new Date(g), "YYYY" == f && (k *= 12), n.setMonth(n.getMonth() + k)) : (h = new Date(m), "YYYY" == f && (f = "MM", k *= 12), "MM" == f && (h = e.resetDateToMin(h, "DD")), e.changeDate(h, f, k, !1), n = m) : "fff" == f ? (e.getPeriodDuration(f, k), q = e.getPeriodDuration(f, k), h ? (h = g, n.setMilliseconds(g.getMilliseconds() - q + 1)) : (h = new Date(m.getTime()), h.setMilliseconds(h.getMilliseconds() - q + 1), n = this.lastDate)) : (q = e.getPeriodDuration(f, k), h ? (h = g, n = new Date(g.getTime() + q - 1)) : (h = new Date(m.getTime() - q + 1), n = m)), a.startTime = h.getTime(), this.hideOutOfScopePeriods &&
                (b && a.startTime < g.getTime() ? d.style.display = "none" : d.style.display = "inline"), h.getTime() > m.getTime() && (q = e.getPeriodDuration("DD", 1), h = new Date(m.getTime() - q)), h.getTime() < g.getTime() && (h = g), "YTD" == f && (a.startTime = h.getTime(), m.getFullYear() < (new Date).getFullYear() && (d.style.display = "none")), a.endTime = n.getTime(), b || (this.skipMark = !0, this.unselectButtons(), d.className = "amChartsButtonSelected " + l.classNamePrefix + "-period-input-selected", t && e.applyStyles(d.style, t.PeriodButtonSelected), a = { type: "changed" },
        ...
        markButtonAsSelected: function() {
            if (!this.skipMark) {
                ...
                for (f = b.length - 1; 0 <= f; f--) {
                    var l = b[f],
                        h = l.button;
                    l.startTime && l.endTime && c == l.startTime && d == l.endTime && (this.unselectButtons(), h.className = "amChartsButtonSelected " + a.classNamePrefix + "-period-input-selected",
...
(function() {
    ...
    e.StockPanel = e.Class({
        ...
        createDrawIcons: function() {
            ...
            f.mouseup(function() { a.handlePencilClick() });
            ...
            if (1 < b.countDataSets("showInSelect")) {
                ...
                for (c = 0; c < f.length; c++)
                    if (n = f[c], !0 === n.showInSelect) {
                        ...
                        try { m.add(g, null) } catch (q) { m.add(g) }
                    }
            ...
            if (0 < b.countDataSets("showInCompare") && 1 < f.length)
                if (l ? (e.addBr(a), e.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c = document.createTextNode(k.langObj.compareText || b.compareText), a.appendChild(c), g = b.listCheckBoxSize, l) {
                    ...
                    for (c = 0; c < f.length; c++) n = f[c], !0 === n.showInCompare && n != b.chart.mainDataSet && (d = document.createElement("div"), d.style.padding = "4px", d.style.position = "relative", d.name = "amCBContainer", d.className = k.classNamePrefix + "-compare-item-div", d.dataSet = n, d.style.height = g + "px", n.compared && (d.style.backgroundColor = b.selectedBackgroundColor), h.appendChild(d), l = document.createElement("div"),
                        l.style.width = g + "px", l.style.height = g + "px", l.style.position = "absolute", l.style.backgroundColor = n.color, d.appendChild(l), l = document.createElement("div"), l.style.width = "100%", l.style.position = "absolute", l.style.left = g + 10 + "px", d.appendChild(l), n = document.createTextNode(n.title), l.style.whiteSpace = "nowrap", l.style.cursor = "default", l.appendChild(n), b.addEventListeners(d));
                    e.addBr(a);
                    e.addBr(a)
                } else {
                    ...
                    try { d.add(g, null) } catch (q) { d.add(g) }
                    for (c = 0; c < f.length; c++)
    ...
    e.StackedBullet = e.Class({
        ...
        addLetter: function(a, b, c) {
            ...
            this.showOnAxis ? (m = isNaN(this.nextAxisY) ? this.axisCoordinate : this.nextY,
                g = h * k, this.nextAxisY = m + k * d) : this.value ? (m = this.value, l.recalculateToPercents && (m = m / l.recBaseValue * 100 - 100), m = l.getCoordinate(m) - this.bulletY, g = h * k) : this.showAt ? (v = this.graphDataItem.values, l.recalculateToPercents && (v = this.graphDataItem.percents), v && (m = l.getCoordinate(v[this.showAt]) - this.bulletY, g = h * k)) : (m = this.nextY, g = h * k);
            a.translate(n, g);
            b.push(a);
            b.translate(0, m);
